    ...
    <section className="directors">
      ...
      <div className="directors-cards">
        {directors.map((director) => (
          <div className="card">
            <img style={{ width: 50 }} width={50} src={director.avatar} />
            <p>{director.name}</p>
          </div>
        ))}
      </div>
